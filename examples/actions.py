...
def actions_ui():
    ...
    return screen(flex_direction="row", align_items="center", justify_content="center")[
        div(flex_direction="column", background_color="333333", min_width=200, border_radius=8, border_width=1)[
            text("Actions", font_weight="bold", color="FFCC00", padding=16),
            *(button(action["text"], on_click=action["action"], background_color="333333", padding=12, border_radius=4) for action in ui_actions)
        ]
    ]