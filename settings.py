...
mod.setting("ui_elements_unfocused_mask_strength", type=float, default=1.0, desc="How far ui_elements_unfocused_mask_color pulls the UI's own colors toward it. 1.0 replaces them outright, 0.5 is a tint over what is there")
