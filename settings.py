...
mod.setting("ui_elements_mouse_use_pynput", type=bool, default=False, desc="Use pynput for blocks_mouse mouse/scroll callbacks instead of canvas.register() (Windows GIL workaround; requires `pip install pynput` in Talon's Python env)")
