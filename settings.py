...
mod.setting("ui_elements_unfocused_inert", type=bool, default=False, desc="While the window does not have focus: no hints, no hover, and a click anywhere but a title bar only takes focus back instead of pressing what is under it")
