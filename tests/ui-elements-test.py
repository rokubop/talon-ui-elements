...
def counter_ui():
    div, text, screen, button, use_state, use_effect = \
        ui_elements_new(["div", "text", "screen", "button", "use_state", "use_effect"])
    ...
    return screen(justify_content="center", align_items="center")[
        div(background_color="333333", padding=32, border_radius=16, border_width=1, border_color="3B71CA")[
            ...
            button("Increment", button_css, on_click=lambda: set_count(count + 1)),
        ]
    ]
