...
class NodeContainer(Node, NodeContainerType):
    ...
    def _resolve_flex_shares(self, children, primary_axis, budget, total_flex_weight):
        ...
        A child wanting less than its share gets frozen at what it wants and
        its surplus goes back in the pot, else nothing claims it and the
        parent renders with a hole on the end.
        """
        shares = {}
        remaining = budget
